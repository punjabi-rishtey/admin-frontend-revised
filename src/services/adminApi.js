  ...
  testimonials: [
    {
      ...
      message:
        "We found each other through Punjabi Rishtey and it was the best decision of our lives. The platform made it easy to connect with genuine profiles.",
    ...
    },
    {
      ...
      message:
        "Thank you Punjabi Rishtey for helping us find our soulmates. Your service is truly exceptional!",
      image_url: "https://via.placeholder.com/300x200",
  ...
  messages: [
    {
      _id: "1",
      message:
        "Welcome to Punjabi Rishtey! Complete your profile to get better matches.",
    ...
    },
    {
      _id: "2",
      message:
        "New Year Special: Get 20% off on all premium plans. Use code NEWYEAR2025",
      createdAt: "2024-12-20",
  ...
  reviews: [
    {
      ...
      message:
        "Excellent platform for finding genuine matches. Highly recommended!",
      ratings: 5,
  ...
  qrcodes: [
    {
      ...
      name: "App Download",
      imageUrl:
        "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://punjabi-rishtey.com/app",
      createdAt: "2024-12-01",
    ...
    },
    {
      ...
      name: "Website Link",
      imageUrl:
        "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://punjabi-rishtey.com",
...
const mockApi = {
  ...
  post: async (url, data) => {
    ...
    if (url.includes("/login")) {
      if (
        data.email === "admin@punjabi-rishtey.com" &&
    ...
    if (url.includes("/utility/recompute-profiles")) {
      return {
        data: { success: true, message: "Profile recomputation started" },
      };
    }
  ...
  put: async (url, data) => {
    ...
    if (url.includes("/membership")) {
      ...
      if (index !== -1) {
        mockData.membershipPlans[index] = {
          ...mockData.membershipPlans[index],
          ...data,
        };
      }
    ...
    if (url.includes("/status")) {
      ...
      if (user) {
        ...
        if (data.status === "Approved") {
          user.metadata.exp_date = new Date(
  ...
  delete: async (url) => {
    ...
    if (url.includes("/membership")) {
      const id = url.match(/membership\/(\w+)/)?.[1];
      mockData.membershipPlans = mockData.membershipPlans.filter(
        (p) => p._id !== id
      );
      return { data: { success: true } };
    }
